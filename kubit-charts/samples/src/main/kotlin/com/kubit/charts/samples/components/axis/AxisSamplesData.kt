...
val sampleHorizontalAxisLight = AxisBuilder()
    ...
    .setDefaultStepStyle(AxisStepStyle.dashed(strokeWidth = 1.dp, strokeColor = Color.White, dashLength = 5.dp, gapLength = 5.dp, phase = 0.dp))
    .addNode(-6f, "-6")
    .addNode(-4f, "-4")
    .addNode(-2f, "-2")
...
val sampleVerticalBTC = AxisBuilder()
    .setDefaultLabelStyle(AxisLabelStyleDefaults.default.copy(color = Color.White))
    .setDefaultStepStyle(AxisStepStyle.solid(strokeWidth = 1.dp, strokeColor = Color.LightGray))
